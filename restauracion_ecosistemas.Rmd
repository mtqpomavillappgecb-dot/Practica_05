---
title: "Projeto de Restauracion de Ecosistemas"
author: "Toa Quindi"
date: "`r Sys.Date()`"
output:
...
- Criar repositorio em Github (  )
- Criar planilha con dados simulados (excel) (ok)
- Criar planilha con dados simulados (Google sheets) (  )
- Criar dados históticos simulados del año 2000 (  )
- Conectar la planilha de datos con Github (  )
- Conectar repositorio e planilha com Rstudio (  )
